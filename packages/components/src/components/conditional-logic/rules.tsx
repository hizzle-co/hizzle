 ...
 *
 */
export const ConditionalLogicRules: React.FC<ConditionalLogicRulesProps> = ( props ) => {

	const { rules, comparisons, availableSmartTags, setConditionalLogicAttribute, disableTags = [], disableProps = [], closeModal = undefined } = props;
