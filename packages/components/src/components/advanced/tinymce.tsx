 ...
 */
export const TinyMCESetting: React.FC<TinyMCESettingProps> = ({
	value,
	onChange,
	...attributes
}) => {
				...
				tinymce: window.tinymce
					? {
							...
							theme_advanced_buttons:
								'bold,italic,underline,|,bullist,numlist,blockquote,|,link,unlink,|,spellchecker,fullscreen,|,formatselect,styleselect',
							drag_drop_upload: true,
							toolbar1:
								'formatselect,bold,italic,bullist,numlist,blockquote,alignleft,aligncenter,alignright,link,spellchecker,wp_adv,dfw',
							toolbar2:
