// IMPORTANT:- This is temporary until the undo-manager WP package
// is fixed. Currently it causes an error.
	...
	const existingChangesIndex = record?.findIndex(
		( { id: recordIdentifier } ) => {
			return typeof recordIdentifier === 'string'
				...
				: fastDeepEqual( recordIdentifier, changes.id );
		}
	);
